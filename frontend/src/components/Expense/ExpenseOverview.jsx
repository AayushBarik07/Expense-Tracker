    ...
    <div className="card">
      <div className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between mb-4">
        <div className="max-w-2xl">
          <h5 className="text-lg font-bold text-[#C6DEC6] mb-2">Expense Overview</h5>
        ...
        <button
          ...
          className="inline-flex min-w-[170px] items-center justify-center gap-2 rounded-2xl bg-linear-to-br from-[#5FD370] via-[#4fbc60] to-[#2f8f3f] px-5 py-4 text-[#031607] shadow-lg shadow-[#5FD3703d] transition-all duration-200 hover:-translate-y-0.5 hover:shadow-xl hover:shadow-[#5FD3704f] focus:outline-none focus:ring-2 focus:ring-[#5FD37080] focus:ring-offset-2 focus:ring-offset-[#0a1f06]"
        >
