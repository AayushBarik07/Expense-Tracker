  ...
  return (
    <div className="fixed top-0 left-0 w-full h-full flex items-center justify-center backdrop-blur-sm bg-[#113E0233] z-50 overflow-y-auto overflow-x-hidden">
      <div className="relative p-4 w-full max-w-2xl max-h-full">
        {/* Modal content   */}
        <div className="relative rounded-2xl border border-[#d8e5d2] bg-linear-to-b from-white to-[#f6faf4] shadow-[0_24px_42px_-30px_rgba(17,62,2,0.28)]"> 
          {/* Modal Header  */}
          <div className="flex items-center justify-between p-5 border-b border-[#e2edde] rounded-t-2xl">
            <h3 className="text-lg font-semibold text-[#113E02]">{title}</h3>
          ...
          {/* Modal Body */}
          <div className="p-4 md:p-5 space-y-4 text-[#113E02]">
            {children}
          </div>
        </div>
      </div>
